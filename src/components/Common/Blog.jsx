...
const Blog = ({url,title, text, width, height}) => {
    const [isMaxLen, setIsMaxLen] = useState(false);
        ...
        <Fragment>
            <div className="col-lg-3 col-md-6 col-sm-12 blogs">
                <div className="card p-4">
                    <img src={url} className="card-img-top" alt="..." width={width} height={height}/>
                    <div className="card-body">
                        <h5 className="card-title">
                            <b>{title.substring(0, titleLen)}{titleLen > 20 ? "": "..."}</b>
                        </h5>
                        <p className="card-text text-center pt-3 text-justify blogs-para">
                            <span>{text.substring(0, maxLen)}{maxLen > 200 ? "": "..."}</span>
                        </p>
                            <hr/>
