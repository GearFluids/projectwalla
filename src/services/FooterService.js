import {envelope, facebook, google, instagram, marker, phone, rAngle, twitter} from "./icons";
...
const menuList = [
    ...
    {key: "projectdomain", icon: rAngle, text: "Project Domain", url: "/project-domain"},
    {key: "blogs", icon: rAngle, text: "Blogs", url: "/blogs"},
];
const weOffer = [
    {key: "weReferGuide", icon: rAngle, text: "We Refer Guide", url: "/services"},
    {key: "Implement", icon: rAngle, text: "Implement", url: "/services"},
];

const services = [
    {key: "ourService", icon: rAngle, text: "Our ServicePage", url: "/services"},
    {key: "domain", icon: rAngle, text: "Domain", url: "/services"},
    {key: "sciSCIEIndex", icon: rAngle, text: "SCI & SCIE Index", url: "/services"},
